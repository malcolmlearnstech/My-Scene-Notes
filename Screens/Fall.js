  ...
  return (
    <SafeAreaView>
      <ScrollView>
        ...
        <Text style={styles.text}>Spicebomb (by Viktor and Rolf)</Text>
        <Image
          style={styles.image}
          source={require('../assets/spicebomb.png')}
        />
        ...
        <Text style={styles.text}>Toy Boy (by Moschino)</Text>
        <Image style={styles.image} source={require('../assets/toyboy.png')} />
        <Text style={styles.details}>
